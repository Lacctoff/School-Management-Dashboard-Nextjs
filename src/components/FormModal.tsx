...
const FormModal = ({
  ...
  id?: number;
    ...
    const bgColor = type === "create" ? "bg-tofunmiYellow" : type === "update" ? "bg-tofunmiSky" : "bg-tofunmiPurple";
  ...
  return (
    <>
      ...
      {open && (
        <div className="bg-black bg-opacity-60 absolute top-0 left-0 w-screen h-screen z-50 flex items-center justify-center">
